...
const toolDescriptions: Array<{ name: string; description: string }> = [
    ...
    { name: 'browser.snapshot', description: 'Return page metadata or run an a11y scan.' },
    { name: 'browser.take_screenshot', description: 'Capture a screenshot for the page or target.' },
    { name: 'browser.click', description: 'Click an element using an a11y node id.' },
    { name: 'browser.fill', description: 'Fill an element using an a11y node id.' },
